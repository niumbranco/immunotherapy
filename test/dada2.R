...
path <- "/Users/catarina/Desktop/NIUM/immunotherapy/workflow_smk/data/fastq/reads_clean"
list.files(path)
...
##3. LEARN THE ERROR RATES      #take time 10 min
...
##4. SAMPLE INFERENCE     #take time, it is 88 samples, more or less 20 min
...
##9. ASSIGN TAXONOMY # very time consuming
taxa <- assignTaxonomy(seqtab.nochim, "/Users/catarina/Desktop/NIUM/immunotherapy/workflow_smk/database/silva_nr99_v138.1_wSpecies_train_set.fa", multithread = TRUE)
taxa.print <- taxa 
